...
class Property:
    ...
    def __init__(self, name, position, price_and_rent, group=None):
        self.name = name
        self.position = position
        self.price, self.base_rent = price_and_rent
        self.owner = None
    ...
    def mortgage_value(self):
        """Return half the purchase price (mortgage payout)."""
        return self.price // 2
...
class PropertyGroup:
    """Represents a collection of properties belonging to the same color group."""
